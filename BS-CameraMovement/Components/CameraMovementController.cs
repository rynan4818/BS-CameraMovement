...
namespace BS_CameraMovement.Components
{
    public class CameraMovementController : IInitializable, ILateTickable, IDisposable
    {
        ...
        {
            KeyboardBinderManualUpdatePatche.IsEditorMode = true;
            ...
            string projectPath = _beatmapProjectManager._originalBeatmapProject;
        ...
        protected virtual void Dispose(bool disposing)
        {
            if (!disposedValue)
            {
                if (disposing)
                {
                    ...
                    KeyboardBinderManualUpdatePatche.IsEditorMode = false;
                }
